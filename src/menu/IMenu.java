...
public interface IMenu {
	...
	Bouton newGame = new Bouton(BOUTTON_POSITION_X, BOUTTON_POSITION_Y, BOUTON_LARGEUR, BOUTON_HAUTEUR);
	Bouton loadGame = new Bouton(BOUTTON_POSITION_X, BOUTTON_POSITION_Y, BOUTON_LARGEUR, BOUTON_HAUTEUR);
	Bouton config = new Bouton(BOUTTON_POSITION_X, BOUTTON_POSITION_Y, BOUTON_LARGEUR, BOUTON_HAUTEUR);
	Bouton quit = new Bouton(BOUTTON_POSITION_X, BOUTTON_POSITION_Y, BOUTON_LARGEUR, BOUTON_HAUTEUR);
	Bouton retour = new Bouton(BOUTON_LARGEUR/4, (int) (DIM_MENU.getHeight() - BOUTON_HAUTEUR *2), BOUTON_LARGEUR/2, BOUTON_HAUTEUR, false);
	Bouton retourMenu = new Bouton(BOUTTON_POSITION_X, BOUTTON_POSITION_Y, BOUTON_LARGEUR, BOUTON_HAUTEUR);
